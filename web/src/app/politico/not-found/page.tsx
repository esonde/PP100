...
export default function PoliticoNotFoundPage() {
  const searchParams = useSearchParams()
  const nome = searchParams.get('name') || 'Politico'
        ...
        <div className="text-center">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <div className="text-left space-y-3 text-gray-700">
              ...
              <p>• <strong>Il nome potrebbe essere scritto diversamente</strong> - Prova varianti del nome</p>
            </div>
          </div>
